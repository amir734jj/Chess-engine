...
namespace ChessEngine.Models.Pieces
{
    ...
    public abstract class Piece : IPiece
    {
        ...
        /// <returns></returns>
        protected abstract bool MightMove(Board board, int from, int to);
        ...
        internal virtual Move GenerateMove(Board board, int from, int to)
        {
            ...
            else// if there is a capture
            {
                ...
                switch (board[to])
                {
                    ...
                    case WhiteRook _ when to == Board.A1:
                    ...
                    case BlackRook _ when to == Board.A8:
        ...
        public abstract TeamEnum TeamEnum { get; }

        public abstract PieceNameEnum PieceNameEnum { get; }

        public override string ToString()
        {
            return $"{TeamEnum}-{PieceNameEnum}";
        }
    }
}
